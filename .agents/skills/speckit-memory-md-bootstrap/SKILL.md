---
name: speckit-memory-md-bootstrap
description: 'Spec-kit workflow command: speckit-memory-md-bootstrap'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: memory-md:commands/speckit.memory-md.bootstrap.md
---
