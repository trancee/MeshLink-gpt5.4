...
public class DiagnosticSinkTest {
    ...
    public fun create_rejectsNonPositiveBufferSizes(): Unit {
        ...
        val error = assertFailsWith<IllegalArgumentException> {
            DiagnosticSink.create(bufferSize = 0)
        }
    ...
    public fun emit_dropsOldestEventAndIncrementsDropCounterWhenBufferIsFull(): Unit {
        ...
        val actualCodes: List<DiagnosticCode> = sink.diagnosticEvents.replayCache.map { event -> event.code }
    ...
    public fun emit_redactsHandshakeFailurePeerIdsWhenEnabled(): Unit {
        ...
        // Assert
        val payload: DiagnosticPayload.HandshakeFailure = assertIs<DiagnosticPayload.HandshakeFailure>(actual)
    ...
    public fun emit_keepsNonPeerPayloadsUnchangedWhenRedactionIsEnabled(): Unit {
        ...
        val expectedPayload: DiagnosticPayload = DiagnosticPayload.BufferPressure(
            usedBytes = 512,
            droppedEvents = 2,
        )
