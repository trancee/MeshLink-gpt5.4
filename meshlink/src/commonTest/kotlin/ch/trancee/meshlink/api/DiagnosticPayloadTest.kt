...
public class DiagnosticPayloadTest {
  ...
  public fun handshakeFailure_retainsPeerAndReason(): Unit {
    ...
    val payload: DiagnosticPayload =
      DiagnosticPayload.HandshakeFailure(peerId = expectedPeerId, reason = expectedReason)

    // Assert
    val actual: DiagnosticPayload.HandshakeFailure =
      assertIs<DiagnosticPayload.HandshakeFailure>(payload)
  ...
  public fun transferProgress_retainsProgressValues(): Unit {
    ...
    // Assert
    val actual: DiagnosticPayload.TransferProgress =
      assertIs<DiagnosticPayload.TransferProgress>(payload)
  ...
  public fun peerLifecycle_retainsPeerAndState(): Unit {
    ...
    // Act
    val payload: DiagnosticPayload =
      DiagnosticPayload.PeerLifecycle(peerId = expectedPeerId, state = expectedState)
  ...
  public fun routingChange_retainsDestinationAndMetric(): Unit {
    ...
    // Act
    val payload: DiagnosticPayload =
      DiagnosticPayload.RoutingChange(destinationPeerId = expectedPeerId, metric = 42)
  ...
  public fun bufferPressure_retainsUsageAndDropCounts(): Unit {
    ...
    // Act
    val payload: DiagnosticPayload =
      DiagnosticPayload.BufferPressure(usedBytes = 512, droppedEvents = 3)

    // Assert
    val actual: DiagnosticPayload.BufferPressure =
      assertIs<DiagnosticPayload.BufferPressure>(payload)
  ...
  public fun powerTierChanged_retainsPreviousAndCurrentTiers(): Unit {
    ...
    // Act
    val payload: DiagnosticPayload =
      DiagnosticPayload.PowerTierChanged(previousTier = "BALANCED", currentTier = "LOW")

    // Assert
    val actual: DiagnosticPayload.PowerTierChanged =
      assertIs<DiagnosticPayload.PowerTierChanged>(payload)
