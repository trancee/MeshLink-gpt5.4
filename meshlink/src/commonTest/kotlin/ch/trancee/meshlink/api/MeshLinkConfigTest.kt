...
public class MeshLinkConfigTest {
  ...
  public fun default_buildsTheBalancedPreset(): Unit {
    ...
    // Assert
    assertEquals(
      expected = MeshLinkConfig.Builder.DEFAULT_APPLICATION_ID,
      actual = actual.applicationId,
    )
    ...
    assertEquals(
      expected = expected.scanDutyCyclePercent,
      actual = actual.scanning.scanDutyCyclePercent,
    )
  ...
  public fun invoke_dslSupportsAllNestedSubConfigurations(): Unit {
    ...
    val actual = MeshLinkConfig {
      ...
      advertising { intervalMs = 180 }
      scanning { scanDutyCyclePercent = 65 }
      connections { maxPeerCount = 9 }
      messaging { maxPayloadBytes = 4_096 }
      transfers { chunkSizeBytes = 2_048 }
      routing { maxRouteCount = 300 }
  ...
  public fun build_rejectsBlankApplicationIds(): Unit {
    ...
    // Act
    val error = assertFailsWith<IllegalArgumentException> { MeshLinkConfig { applicationId = "" } }
  ...
  public fun build_rejectsNonPositiveDiagnosticBufferSizes(): Unit {
    ...
    val error =
      assertFailsWith<IllegalArgumentException> {
        MeshLinkConfig { diagnostics { bufferSize = 0 } }
      }
  ...
  public fun build_clampsRegionSensitiveDiscoveryParameters(): Unit {
    ...
    val actual = MeshLinkConfig {
      ...
      advertising { intervalMs = 100 }
      scanning { scanDutyCyclePercent = 95 }
    }
  ...
  public fun build_clampsRangesForBestEffortParameters(): Unit {
    ...
    // Act
    val actual = MeshLinkConfig {
      connections { maxPeerCount = 99 }
      messaging { maxPayloadBytes = 200_000 }
      transfers { chunkSizeBytes = 100 }
      routing { maxRouteCount = 9_999 }
      diagnostics { bufferSize = 9_999 }
    }
