...
public class ChunkAckMessageCodecTest {
  ...
  public fun encodeAndDecode_roundTripChunkAckMessage(): Unit {
    ...
    assertEquals(
      ...
      message =
        "ChunkAckMessageCodec should preserve the highest contiguous acknowledged chunk index",
    )
    assertContentEquals(
  ...
  public fun decode_throwsWhenPayloadHeaderIsIncomplete(): Unit {
    ...
    // Act
    val error =
      assertFailsWith<IllegalArgumentException> { ChunkAckMessageCodec.decode(payload = payload) }
