...
public class WireCodecTest {
  ...
  public fun encodeAndDecode_roundTripHelloMessageThroughDispatcher(): Unit {
    // Arrange
    val expectedPeerId: ByteArray =
      byteArrayOf(0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, 0x2C)
    val expectedAppIdHash: Int = 0x11223344
    val message = HelloMessage(peerId = expectedPeerId, appIdHash = expectedAppIdHash)

    // Act
    val decoded: HelloMessage =
      assertIs<HelloMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
  ...
  public fun encode_writesMessageTypeAndLittleEndianPayloadLength(): Unit {
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.HELLO.code.toByte(), 0x10, 0x00, 0x00, 0x00) + expectedPayload,
      actual = encoded,
      message =
        "WireCodec should write the one-byte message type and little-endian payload length before the payload",
    )
  }
  ...
  public fun encodeAndDecode_roundTripHandshakeMessageThroughDispatcher(): Unit {
    ...
    val message = HandshakeMessage(round = HandshakeRound.ONE, payload = expectedPayload)

    // Act
    val decoded: HandshakeMessage =
      assertIs<HandshakeMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
  ...
  public fun encode_writesHandshakeTypeAndPayloadLength(): Unit {
    // Arrange
    val message = HandshakeMessage(round = HandshakeRound.THREE, payload = byteArrayOf(0x61, 0x62))
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.HANDSHAKE.code.toByte(), 0x03, 0x00, 0x00, 0x00) + expectedPayload,
      actual = encoded,
      message =
        "WireCodec should frame HANDSHAKE messages with the correct type tag and payload length",
    )
  }
  ...
  public fun encodeAndDecode_roundTripKeepaliveMessageThroughDispatcher(): Unit {
    ...
    // Act
    val decoded: KeepaliveMessage =
      assertIs<KeepaliveMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
  ...
  public fun encode_writesKeepaliveTypeAndZeroLengthPayload(): Unit {
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.KEEPALIVE.code.toByte(), 0x00, 0x00, 0x00, 0x00) + expectedPayload,
      actual = encoded,
  ...
  public fun encodeAndDecode_roundTripRoutedMessageThroughDispatcher(): Unit {
    ...
    val message = RoutedMessage(hopCount = 1u, maxHops = 4u, payload = expectedPayload)

    // Act
    val decoded: RoutedMessage =
      assertIs<RoutedMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
  ...
  public fun encode_writesRoutedMessageTypeAndPayloadLength(): Unit {
    // Arrange
    val message =
      RoutedMessage(hopCount = 2u, maxHops = 5u, payload = byteArrayOf(0x21, 0x22, 0x23))
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.ROUTED_MESSAGE.code.toByte(), 0x05, 0x00, 0x00, 0x00) +
          expectedPayload,
      actual = encoded,
      message =
        "WireCodec should frame ROUTED_MESSAGE messages with the correct type tag and payload length",
    )
  }
  ...
  public fun encodeAndDecode_roundTripUpdateMessageThroughDispatcher(): Unit {
    ...
    val expectedDestinationPeerId: ByteArray =
      byteArrayOf(0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3A, 0x3B, 0x3C)
    val message =
      UpdateMessage(destinationPeerId = expectedDestinationPeerId, metric = 123, seqno = 7)

    // Act
    val decoded: UpdateMessage =
      assertIs<UpdateMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
    ...
    assertContentEquals(
      ...
      message =
        "WireCodec should preserve the UPDATE destination peer identifier through encode/decode dispatch",
    )
    assertEquals(
      expected = 123,
    ...
    assertEquals(
      ...
      message =
        "WireCodec should preserve the UPDATE sequence number through encode/decode dispatch",
    )
  }
  ...
  public fun encode_writesUpdateTypeAndPayloadLength(): Unit {
    ...
    val message =
      UpdateMessage(
        destinationPeerId =
          byteArrayOf(0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4A, 0x4B, 0x4C),
        metric = 99,
        seqno = 5,
      )
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.UPDATE.code.toByte(), 0x14, 0x00, 0x00, 0x00) + expectedPayload,
      actual = encoded,
      message =
        "WireCodec should frame UPDATE messages with the correct type tag and payload length",
    )
  }
  ...
  public fun encodeAndDecode_roundTripDeliveryAckMessageThroughDispatcher(): Unit {
    ...
    // Act
    val decoded: DeliveryAckMessage =
      assertIs<DeliveryAckMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
    ...
    assertEquals(
      ...
      message =
        "WireCodec should preserve the DELIVERY_ACK message identifier through encode/decode dispatch",
    )
  }
  ...
  public fun encode_writesDeliveryAckTypeAndPayloadLength(): Unit {
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.DELIVERY_ACK.code.toByte(), 0x08, 0x00, 0x00, 0x00) +
          expectedPayload,
      actual = encoded,
      message =
        "WireCodec should frame DELIVERY_ACK messages with the correct type tag and payload length",
    )
  }
  ...
  public fun encodeAndDecode_roundTripNackMessageThroughDispatcher(): Unit {
    // Arrange
    val message = NackMessage(messageId = 0x1020304050607080, reasonCode = 503)

    // Act
    val decoded: NackMessage =
      assertIs<NackMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
    ...
    assertEquals(
      ...
      actual = decoded.messageId,
      message =
        "WireCodec should preserve the NACK message identifier through encode/decode dispatch",
    )
    assertEquals(
      expected = 503,
  ...
  public fun encode_writesNackTypeAndPayloadLength(): Unit {
    // Arrange
    val message = NackMessage(messageId = 0x0102030405060708, reasonCode = 404)
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.NACK.code.toByte(), 0x0C, 0x00, 0x00, 0x00) + expectedPayload,
      actual = encoded,
  ...
  public fun encodeAndDecode_roundTripResumeRequestMessageThroughDispatcher(): Unit {
    // Arrange
    val message =
      ResumeRequestMessage(transferId = 0x0102030405060708, resumeOffset = 0x1112131415161718)

    // Act
    val decoded: ResumeRequestMessage =
      assertIs<ResumeRequestMessage>(
    ...
    assertEquals(
      ...
      message =
        "WireCodec should preserve the RESUME_REQUEST transfer identifier through encode/decode dispatch",
    )
    assertEquals(
  ...
  public fun encode_writesResumeRequestTypeAndPayloadLength(): Unit {
    // Arrange
    val message =
      ResumeRequestMessage(transferId = 0x2122232425262728, resumeOffset = 0x3132333435363738)
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.RESUME_REQUEST.code.toByte(), 0x10, 0x00, 0x00, 0x00) +
          expectedPayload,
      actual = encoded,
      message =
        "WireCodec should frame RESUME_REQUEST messages with the correct type tag and payload length",
    )
  }
  ...
  public fun encodeAndDecode_roundTripBroadcastMessageThroughDispatcher(): Unit {
    // Arrange
    val expectedOriginPeerId: ByteArray =
      byteArrayOf(0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5A, 0x5B, 0x5C)
    ...
    // Act
    val decoded: BroadcastMessage =
      assertIs<BroadcastMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
    ...
    assertContentEquals(
      ...
      message =
        "WireCodec should preserve the BROADCAST origin peer identifier through encode/decode dispatch",
    )
    assertEquals(
      expected = 123,
      actual = decoded.sequenceNumber,
      message =
        "WireCodec should preserve the BROADCAST sequence number through encode/decode dispatch",
    )
    assertEquals(
      expected = 2u,
      actual = decoded.maxHops,
  ...
  public fun encode_writesBroadcastTypeAndPayloadLength(): Unit {
    ...
    val message =
      BroadcastMessage(
        originPeerId =
          byteArrayOf(0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A, 0x6B, 0x6C),
        sequenceNumber = 7,
        maxHops = 4u,
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.BROADCAST.code.toByte(), 0x13, 0x00, 0x00, 0x00) + expectedPayload,
      actual = encoded,
      message =
        "WireCodec should frame BROADCAST messages with the correct type tag and payload length",
    )
  }
  ...
  public fun encodeAndDecode_roundTripRotationAnnouncementMessageThroughDispatcher(): Unit {
    ...
    val decoded: RotationAnnouncementMessage =
      assertIs<RotationAnnouncementMessage>(
        WireCodec.decode(encoded = WireCodec.encode(message = message))
      )
  ...
  public fun encode_writesRotationAnnouncementTypeAndPayloadLength(): Unit {
    ...
    assertContentEquals(
      ...
      actual = encoded,
      message =
        "WireCodec should frame ROTATION_ANNOUNCEMENT messages with the correct type tag and payload length",
    )
  }
  ...
  public fun encodeAndDecode_roundTripChunkMessageThroughDispatcher(): Unit {
    ...
    val message =
      ChunkMessage(transferId = 0x1112131415161718, chunkIndex = 2, payload = expectedPayload)

    // Act
    val decoded: ChunkMessage =
      assertIs<ChunkMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
    ...
    assertEquals(
      ...
      actual = decoded.transferId,
      message =
        "WireCodec should preserve the CHUNK transfer identifier through encode/decode dispatch",
    )
    assertEquals(
      expected = 2,
  ...
  public fun encode_writesChunkTypeAndPayloadLength(): Unit {
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.CHUNK.code.toByte(), 0x0E, 0x00, 0x00, 0x00) + expectedPayload,
      actual = encoded,
  ...
  public fun encodeAndDecode_roundTripChunkAckMessageThroughDispatcher(): Unit {
    ...
    // Act
    val decoded: ChunkAckMessage =
      assertIs<ChunkAckMessage>(WireCodec.decode(encoded = WireCodec.encode(message = message)))
    ...
    assertEquals(
      ...
      actual = decoded.transferId,
      message =
        "WireCodec should preserve the CHUNK_ACK transfer identifier through encode/decode dispatch",
    )
    assertEquals(
      expected = 4,
      actual = decoded.highestContiguousChunkIndex,
      message =
        "WireCodec should preserve the CHUNK_ACK highest contiguous chunk index through encode/decode dispatch",
    )
    assertContentEquals(
  ...
  public fun encode_writesChunkAckTypeAndPayloadLength(): Unit {
    ...
    assertContentEquals(
      expected =
        byteArrayOf(MessageType.CHUNK_ACK.code.toByte(), 0x0E, 0x00, 0x00, 0x00) + expectedPayload,
      actual = encoded,
      message =
        "WireCodec should frame CHUNK_ACK messages with the correct type tag and payload length",
    )
  }
  ...
  public fun encode_throwsWhenMessageImplementationIsNotYetSupported(): Unit {
    ...
    // Act
    val error =
      assertFailsWith<UnsupportedOperationException> { WireCodec.encode(message = message) }
    ...
    assertEquals(
      ...
      message =
        "WireCodec should surface unsupported message implementations until their specific codecs are implemented",
    )
  }
  ...
  public fun decode_throwsWhenFrameIsShorterThanHeader(): Unit {
    ...
    // Act
    val error = assertFailsWith<IllegalArgumentException> { WireCodec.decode(encoded = encoded) }
  ...
  public fun decode_throwsWhenDeclaredPayloadLengthDoesNotMatchActualLength(): Unit {
    ...
    val encoded: ByteArray =
      byteArrayOf(MessageType.HELLO.code.toByte(), 0x02, 0x00, 0x00, 0x00, 0x0A)
    ...
    assertEquals(
      ...
      actual = error.message,
      message =
        "WireCodec should reject frames whose declared payload length differs from the actual byte count",
    )
  }
  ...
  public fun decode_throwsWhenDeclaredPayloadLengthIsNegative(): Unit {
    ...
    assertEquals(
      ...
      actual = error.message,
      message =
        "WireCodec should reject frames whose payload length header decodes to a negative value",
    )
  }
