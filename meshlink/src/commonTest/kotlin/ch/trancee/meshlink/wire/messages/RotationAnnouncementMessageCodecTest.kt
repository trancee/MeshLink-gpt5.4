...
public class RotationAnnouncementMessageCodecTest {
    ...
    public fun encodeAndDecode_roundTripRotationAnnouncementMessage(): Unit {
        ...
        val decoded: RotationAnnouncementMessage = RotationAnnouncementMessageCodec.decode(payload = encoded)
    ...
    public fun decode_throwsWhenPayloadLengthIsInvalid(): Unit {
        ...
        assertEquals(
            ...
            actual = error.message,
            message = "RotationAnnouncementMessageCodec should reject malformed ROTATION_ANNOUNCEMENT payload sizes",
        )
    }
}
