...
public class InboundValidatorTest {
  ...
  public fun validate_returnsValidForWellFormedHelloFrame(): Unit {
    ...
    val encoded: ByteArray =
      WireCodec.encode(
        message =
          HelloMessage(
            peerId =
              byteArrayOf(0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C),
    ...
    assertEquals(
      ...
      actual = actual,
      message =
        "InboundValidator should accept well-formed HELLO frames within the configured bounds",
    )
  }
  ...
  public fun validate_returnsValidForWellFormedHandshakeFrame(): Unit {
    ...
    val encoded: ByteArray =
      WireCodec.encode(
        message = HandshakeMessage(round = HandshakeRound.TWO, payload = byteArrayOf(0x21, 0x22))
      )
    ...
    assertEquals(
      ...
      actual = actual,
      message =
        "InboundValidator should accept well-formed HANDSHAKE frames that include a round byte",
    )
  }
  ...
  public fun validate_rejectsFramesShorterThanHeader(): Unit {
    ...
    // Act
    val actual: ValidationResult.Invalid =
      assertIs<ValidationResult.Invalid>(validator.validate(encoded = encoded))
  ...
  public fun validate_rejectsFramesWithNegativePayloadLength(): Unit {
    ...
    assertEquals(
      ...
      actual = actual.code,
      message =
        "InboundValidator should reject frames whose payload length header decodes to a negative value",
    )
    assertEquals(
  ...
  public fun validate_rejectsFramesWhoseDeclaredLengthDoesNotMatchActualBytes(): Unit {
    ...
    assertEquals(
      ...
      actual = actual.code,
      message =
        "InboundValidator should reject frames whose declared payload length differs from the actual byte count",
    )
    assertEquals(
  ...
  public fun validate_rejectsFramesWhosePayloadExceedsConfiguredMaximum(): Unit {
    ...
    val encoded: ByteArray =
      WireCodec.encode(
        message =
          HandshakeMessage(round = HandshakeRound.ONE, payload = byteArrayOf(0x31, 0x32, 0x33))
      )
    ...
    assertEquals(
      ...
      actual = actual.reason,
      message =
        "InboundValidator should report the configured maximum payload size in its failure reason",
    )
  }
  ...
  public fun validate_returnsValidForWellFormedUpdateFrame(): Unit {
    ...
    assertEquals(
      ...
      actual = actual,
      message =
        "InboundValidator should accept well-formed UPDATE frames with the expected fixed payload size",
    )
  }
  ...
  public fun validate_rejectsUpdateFramesWithUnexpectedPayloadLength(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.UPDATE.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
    ...
    assertEquals(
      ...
      actual = actual.code,
      message =
        "InboundValidator should reject UPDATE frames whose payload size is not exactly 20 bytes",
    )
    assertEquals(
  ...
  public fun validate_returnsValidForRoutedMessagesBelowHopLimit(): Unit {
    ...
    val encoded: ByteArray =
      WireCodec.encode(
        message = RoutedMessage(hopCount = 1u, maxHops = 3u, payload = byteArrayOf(0x41))
      )
    ...
    assertEquals(
      ...
      actual = actual,
      message =
        "InboundValidator should accept routed messages whose hopCount remains below maxHops",
    )
  }
  ...
  public fun validate_rejectsRoutedMessagesWithoutHopHeader(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.ROUTED_MESSAGE.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
    ...
    assertEquals(
      ...
      actual = actual.code,
      message =
        "InboundValidator should reject routed messages that do not contain both hop header bytes",
    )
    assertEquals(
  ...
  public fun validate_returnsValidForWellFormedChunkFrame(): Unit {
    ...
    val encoded: ByteArray =
      WireCodec.encode(
        message =
          ChunkMessage(transferId = 0x0102030405060708, chunkIndex = 1, payload = byteArrayOf(0x11))
      )
  ...
  public fun validate_rejectsChunkFramesWithoutHeader(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.CHUNK.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
  ...
  public fun validate_returnsValidForWellFormedChunkAckFrame(): Unit {
    ...
    assertEquals(
      ...
      actual = actual,
      message =
        "InboundValidator should accept CHUNK_ACK frames that include transferId and highestContiguousChunkIndex",
    )
  }
  ...
  public fun validate_rejectsChunkAckFramesWithoutHeader(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.CHUNK_ACK.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
  ...
  public fun validate_rejectsRoutedMessagesAtHopLimit(): Unit {
    ...
    val encoded: ByteArray =
      WireCodec.encode(
        message = RoutedMessage(hopCount = 3u, maxHops = 3u, payload = byteArrayOf(0x51))
      )
  ...
  public fun validate_returnsValidForWellFormedDeliveryAckFrame(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      WireCodec.encode(message = DeliveryAckMessage(messageId = 0x2122232425262728))
    ...
    assertEquals(
      ...
      actual = actual,
      message =
        "InboundValidator should accept DELIVERY_ACK frames with the expected fixed payload size",
    )
  }
  ...
  public fun validate_rejectsDeliveryAckFramesWithUnexpectedPayloadLength(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.DELIVERY_ACK.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
    ...
    assertEquals(
      ...
      actual = actual.code,
      message =
        "InboundValidator should reject DELIVERY_ACK frames with malformed fixed payload sizes",
    )
    assertEquals(
  ...
  public fun validate_returnsValidForWellFormedNackFrame(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      WireCodec.encode(message = NackMessage(messageId = 0x3132333435363738, reasonCode = 404))
  ...
  public fun validate_rejectsNackFramesWithUnexpectedPayloadLength(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.NACK.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
  ...
  public fun validate_rejectsKeepaliveFramesWithUnexpectedPayloadBytes(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.KEEPALIVE.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
  ...
  public fun validate_returnsValidForWellFormedBroadcastFrame(): Unit {
    ...
    assertEquals(
      ...
      actual = actual,
      message =
        "InboundValidator should accept BROADCAST frames whose header is complete and maxHops is positive",
    )
  }
  ...
  public fun validate_rejectsBroadcastFramesWithoutCompleteHeader(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.BROADCAST.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
  ...
  public fun validate_rejectsHelloFramesWithUnexpectedPayloadLength(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.HELLO.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
    ...
    assertEquals(
      ...
      actual = actual.code,
      message =
        "InboundValidator should reject HELLO frames whose payload size is not exactly 16 bytes",
    )
    assertEquals(
  ...
  public fun validate_returnsValidForWellFormedResumeRequestFrame(): Unit {
    ...
    val encoded: ByteArray =
      WireCodec.encode(
        message =
          ResumeRequestMessage(transferId = 0x6162636465666768, resumeOffset = 0x7172737475767778)
      )
    ...
    assertEquals(
      ...
      actual = actual,
      message =
        "InboundValidator should accept RESUME_REQUEST frames with the expected fixed payload size",
    )
  }
  ...
  public fun validate_rejectsResumeRequestFramesWithUnexpectedPayloadLength(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.RESUME_REQUEST.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
    ...
    assertEquals(
      ...
      actual = actual.code,
      message =
        "InboundValidator should reject RESUME_REQUEST frames with malformed fixed payload sizes",
    )
    assertEquals(
  ...
  public fun validate_returnsValidForWellFormedRotationAnnouncementFrame(): Unit {
    ...
    assertEquals(
      ...
      actual = actual,
      message =
        "InboundValidator should accept ROTATION_ANNOUNCEMENT frames with the expected fixed payload size",
    )
  }
  ...
  public fun validate_rejectsRotationAnnouncementFramesWithUnexpectedPayloadLength(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.ROTATION_ANNOUNCEMENT.code.toByte(), 0x01, 0x00, 0x00, 0x00, 0x7F)
    ...
    assertEquals(
      ...
      actual = actual.code,
      message =
        "InboundValidator should reject ROTATION_ANNOUNCEMENT frames with malformed fixed payload sizes",
    )
    assertEquals(
      expected = "ROTATION_ANNOUNCEMENT payload must be exactly 128 bytes.",
      actual = actual.reason,
      message =
        "InboundValidator should explain ROTATION_ANNOUNCEMENT payload size violations clearly",
    )
  }
  ...
  public fun validate_rejectsHandshakeFramesWithoutRoundByte(): Unit {
    ...
    val validator = InboundValidator()
    val encoded: ByteArray =
      byteArrayOf(MessageType.HANDSHAKE.code.toByte(), 0x00, 0x00, 0x00, 0x00)
