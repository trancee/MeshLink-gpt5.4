  ...
  public fun roundTrip_allCurrentlySupportedMessageTypes(): Unit {
    ...
    val messages: List<WireMessage> =
      listOf(
        ...
        HandshakeMessage(round = HandshakeRound.THREE, payload = byteArrayOf(0x21, 0x22, 0x23)),
        KeepaliveMessage,
        RoutedMessage(hopCount = 1u, maxHops = 4u, payload = byteArrayOf(0x31, 0x32)),
        UpdateMessage(
          destinationPeerId =
        ...
        NackMessage(messageId = 0x2122232425262728, reasonCode = 502),
        ResumeRequestMessage(transferId = 0x3132333435363738, resumeOffset = 0x4142434445464748),
        BroadcastMessage(
          originPeerId =
    ...
    // Act
    val actualRoundTrips: List<Pair<ByteArray, ByteArray>> =
