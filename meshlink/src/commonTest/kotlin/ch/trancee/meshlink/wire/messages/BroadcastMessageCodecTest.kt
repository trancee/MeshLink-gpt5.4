...
public class BroadcastMessageCodecTest {
  ...
  public fun encode_throwsWhenOriginPeerIdLengthIsInvalid(): Unit {
    ...
    // Act
    val error =
      assertFailsWith<IllegalArgumentException> { BroadcastMessageCodec.encode(message = message) }
  ...
  public fun decode_throwsWhenPayloadHeaderIsIncomplete(): Unit {
    ...
    // Act
    val error =
      assertFailsWith<IllegalArgumentException> { BroadcastMessageCodec.decode(payload = payload) }
