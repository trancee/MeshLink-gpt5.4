...
public class HandshakeMessageCodecTest {
    ...
    public fun decode_throwsWhenPayloadIsMissingRoundByte(): Unit {
        ...
        val error = assertFailsWith<IllegalArgumentException> {
            HandshakeMessageCodec.decode(payload = payload)
        }
        ...
        assertEquals(
            ...
            message = "HandshakeMessageCodec should reject payloads that do not contain the handshake round",
        )
    }
