...
public class RoutingTest {
  ...
  public fun engines_convergeToTheLowestMetricMultiHopRouteAcrossTopologyChanges(): Unit {
    ...
    // Assert
    assertEquals(
      expected = secondRelayPeerId,
      actual = firstEngine.nextHopFor(destinationPeerId = destinationPeerId),
    )
    assertEquals(
      expected = firstRelayPeerId,
      actual = secondEngine.nextHopFor(destinationPeerId = destinationPeerId),
    )
  }
}
