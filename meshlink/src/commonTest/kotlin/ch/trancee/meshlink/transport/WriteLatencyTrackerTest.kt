...
public class WriteLatencyTrackerTest {
  ...
  public fun record_rejectsNegativeDurations(): Unit {
    ...
    // Act
    val error = assertFailsWith<IllegalArgumentException> { tracker.record(durationMillis = -1) }
  ...
  public fun init_rejectsNonPositiveWindowSizes(): Unit {
    ...
    // Act
    val error = assertFailsWith<IllegalArgumentException> { WriteLatencyTracker(windowSize = 0) }
