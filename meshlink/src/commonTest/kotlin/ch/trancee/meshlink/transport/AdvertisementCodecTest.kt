...
public class AdvertisementCodecTest {
    ...
    public fun encodeAndDecode_roundTripPseudonymAndPowerTier(): Unit {
        // Arrange
        val pseudonym = byteArrayOf(0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B)
    ...
    public fun encode_fitsWithinTheBleAdvertisementBudget(): Unit {
        // Arrange
        val pseudonym = ByteArray(size = AdvertisementCodec.PSEUDONYM_LENGTH_BYTES) { index -> index.toByte() }

        // Act
        val actual = AdvertisementCodec.encode(
            pseudonym = pseudonym,
