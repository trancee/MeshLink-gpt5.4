...
public class CutThroughRelayIntegrationTest {
    ...
    public fun relayPipeline_appendsVisitedHopsAcrossThreeNodes(): Unit {
        ...
        // Act
        val firstForwardedFrame = firstRelay.relayChunk0(
            chunk0 = chunk0,
            localHopPeerId = firstHopPeerId,
        )
        val secondForwardedFrame = secondRelay.relayChunk0(
            chunk0 = firstForwardedFrame,
            localHopPeerId = secondHopPeerId,
        )
