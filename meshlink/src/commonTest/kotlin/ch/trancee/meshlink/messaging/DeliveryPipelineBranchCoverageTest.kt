...
public class DeliveryPipelineBranchCoverageTest {
  ...
  public fun failTimedOut_rejectsNegativeTimestamps(): Unit {
    ...
    // Act
    val error =
      assertFailsWith<IllegalArgumentException> { pipeline.failTimedOut(nowEpochMillis = -1L) }

    // Assert
    assertEquals(
      expected = "DeliveryPipeline nowEpochMillis must be greater than or equal to 0.",
