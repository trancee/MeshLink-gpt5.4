...
public class MeshStateManagerTest {
  ...
  public fun sweep_canReportBothStalePeersAndExpiredRoutesInTheSamePass(): Unit {
    ...
    val actual =
      manager.sweep(
        ...
        routes =
          listOf(ManagedRoute(destinationPeerId = expiredRoutePeerId, expiresAtEpochMillis = 50L)),
        nowEpochMillis = 100L,
      )
  ...
  public fun sweep_rejectsNegativeTimestamps(): Unit {
    ...
    val error =
      assertFailsWith<IllegalArgumentException> {
        manager.sweep(peers = emptyList(), routes = emptyList(), nowEpochMillis = -1L)
      }
  ...
  public fun init_rejectsNonPositivePeerTimeouts(): Unit {
    ...
    // Act
    val error =
      assertFailsWith<IllegalArgumentException> { MeshStateManager(stalePeerTimeoutMillis = 0L) }
