...
public class PseudonymRotationIntegrationTest {
  ...
  public fun engine_identityApi_matchesTheUnderlyingRotatorOutput(): Unit {
    ...
    // Act
    val expected =
      engine.pseudonymRotator.pseudonymAt(identityKey = identityKey, timestampMillis = 1234L)
    val actual = engine.pseudonymAt(identityKey = identityKey, timestampMillis = 1234L)
