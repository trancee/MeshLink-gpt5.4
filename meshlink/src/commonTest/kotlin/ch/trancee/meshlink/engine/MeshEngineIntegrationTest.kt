...
public class MeshEngineIntegrationTest {
    ...
    public fun harness_completesTheThreeMessageNoiseHandshakeAcrossTwoEngines(): Unit {
        ...
        // Act
        val first: HandshakeMessage = harness.firstEngine.beginHandshake(
        ...
        val second: HandshakeMessage = harness.secondEngine.continueHandshake(
            peerId = harness.firstPeerId,
        ...
        val third: HandshakeMessage = harness.firstEngine.continueHandshake(
            peerId = harness.secondPeerId,
        ...
        assertFalse(actual = harness.firstEngine.handshakeManager.isHandshakeActive(peerId = harness.secondPeerId))
        assertFalse(actual = harness.secondEngine.handshakeManager.isHandshakeActive(peerId = harness.firstPeerId))
    }
}

private class MeshTestHarness private constructor(
