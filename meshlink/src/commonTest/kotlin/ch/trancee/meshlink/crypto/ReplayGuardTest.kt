...
public class ReplayGuardTest {
  ...
  public fun checkAndMark_acceptsFirstNonce(): Unit {
    ...
    // Assert
    assertTrue(actual = actual, message = "ReplayGuard should accept the first nonce it sees")
  }
  ...
  public fun checkAndMark_rejectsDuplicateNonce(): Unit {
    ...
    // Assert
    assertFalse(actual = actual, message = "ReplayGuard should reject duplicate nonces")
  }
  ...
  public fun checkAndMark_acceptsOutOfOrderNonceWithinWindowOnce(): Unit {
    ...
    assertTrue(
      actual = actual,
      message =
        "ReplayGuard should accept unseen nonces that arrive out of order within the active window",
    )
  }
  ...
  public fun checkAndMark_rejectsNegativeNonce(): Unit {
    ...
    // Assert
    assertFalse(actual = actual, message = "ReplayGuard should reject negative nonces")
  }
}
