...
public class ConstantTimeEqualsTest {
    ...
    public fun bytes_returnsTrueForEqualArrays(): Unit {
        ...
        assertTrue(
            actual = actual,
            message = "ConstantTimeEquals should report equal arrays as equal",
        )
    }
    ...
    public fun bytes_returnsFalseWhenLeftArrayIsLongerThanRightArray(): Unit {
        ...
        assertFalse(
            actual = actual,
            message = "ConstantTimeEquals should reject arrays when the left side is longer than the right side",
        )
    }
}
