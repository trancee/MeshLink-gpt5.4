...
public class AndroidCryptoProviderTest {
  ...
  public fun generateX25519KeyPair_returnsExpectedKeyLengths(): Unit {
    ...
    assertEquals(
      ...
      message = "AndroidCryptoProvider should expose raw 32-byte X25519 public keys",
    )
    assertEquals(
      expected = 32,
      actual = actual.secretKey.size,
      message = "AndroidCryptoProvider should expose raw 32-byte X25519 private keys",
    )
  }
  ...
  public fun x25519_generatesMatchingSharedSecretsForBothPeers(): Unit {
    ...
    assertContentEquals(
      ...
      message = "AndroidCryptoProvider should derive the same X25519 shared secret for both peers",
    )
  }
  ...
  public fun x25519_throwsWhenPrivateKeyLengthIsInvalid(): Unit {
    ...
    assertEquals(
      ...
      message = "AndroidCryptoProvider should reject malformed X25519 private keys",
    )
  }
  ...
  public fun x25519_throwsWhenPublicKeyLengthIsInvalid(): Unit {
    ...
    assertEquals(
      ...
      actual = error.message,
      message = "AndroidCryptoProvider should reject malformed X25519 public keys",
    )
  }
  ...
  public fun generateEd25519KeyPair_returnsExpectedKeyLengths(): Unit {
    ...
    assertEquals(
      ...
      actual = actual.publicKey.size,
      message = "AndroidCryptoProvider should expose raw 32-byte Ed25519 public keys",
    )
    assertEquals(
      expected = Identity.SECRET_KEY_SIZE,
      actual = actual.secretKey.size,
      message = "AndroidCryptoProvider should expose 64-byte Ed25519 secret keys",
    )
  }
  ...
  public fun ed25519SignAndVerify_roundTripSignature(): Unit {
    ...
    assertTrue(
      actual = actual,
      message =
        "AndroidCryptoProvider should verify signatures produced by its Ed25519 signing implementation",
    )
  }
  ...
  public fun ed25519Verify_returnsFalseForTamperedMessage(): Unit {
    ...
    assertFalse(
      actual = actual,
      message =
        "AndroidCryptoProvider should reject Ed25519 signatures when the signed message changes",
    )
  }
  ...
  public fun ed25519Sign_throwsWhenSecretKeyLengthIsInvalid(): Unit {
    ...
    assertEquals(
      ...
      actual = error.message,
      message = "AndroidCryptoProvider should reject malformed Ed25519 secret keys",
    )
  }
  ...
  public fun ed25519Verify_throwsWhenPublicKeyLengthIsInvalid(): Unit {
    ...
    assertEquals(
      ...
      actual = error.message,
      message = "AndroidCryptoProvider should reject malformed Ed25519 public keys",
    )
  }
  ...
  public fun hkdfSha256_matchesRfc5869TestVector(): Unit {
    ...
    assertContentEquals(
      expected = expected,
      actual = actual,
      message = "AndroidCryptoProvider should match the RFC 5869 HKDF-SHA256 test vector",
    )
  }
  ...
  public fun hkdfSha256_returnsEmptyOutputWhenRequestedLengthIsZeroAndSaltIsEmpty(): Unit {
    ...
    assertContentEquals(
      ...
      actual = actual,
      message =
        "AndroidCryptoProvider should allow zero-length HKDF output requests and empty salts",
    )
  }
  ...
  public fun hkdfSha256_throwsWhenOutputLengthIsNegative(): Unit {
    ...
    assertEquals(
      ...
      actual = error.message,
      message = "AndroidCryptoProvider should reject negative HKDF output lengths",
    )
  }
  ...
  public fun chaCha20Poly1305_encryptAndDecrypt_roundTripPlaintext(): Unit {
    ...
    assertContentEquals(
      expected = plaintext,
      actual = actual,
      message = "AndroidCryptoProvider should round-trip plaintext through ChaCha20-Poly1305",
    )
  }
  ...
  public fun chaCha20Poly1305_encryptAndDecrypt_roundTripPlaintextWithoutAad(): Unit {
    ...
    assertContentEquals(
      ...
      actual = actual,
      message =
        "AndroidCryptoProvider should also round-trip ChaCha20-Poly1305 payloads when no AAD is provided",
    )
  }
  ...
  public fun chaCha20Poly1305Encrypt_throwsWhenKeyLengthIsInvalid(): Unit {
    ...
    assertEquals(
      ...
      actual = error.message,
      message = "AndroidCryptoProvider should reject malformed ChaCha20-Poly1305 keys",
    )
  }
  ...
  public fun chaCha20Poly1305Encrypt_throwsWhenNonceLengthIsInvalid(): Unit {
    ...
    assertEquals(
      ...
      actual = error.message,
      message =
        "AndroidCryptoProvider should reject malformed ChaCha20-Poly1305 nonces during encryption",
    )
  }
  ...
  public fun chaCha20Poly1305Decrypt_throwsWhenKeyLengthIsInvalid(): Unit {
    ...
    assertEquals(
      ...
      actual = error.message,
      message =
        "AndroidCryptoProvider should reject malformed ChaCha20-Poly1305 keys during decryption",
    )
  }
  ...
  public fun chaCha20Poly1305Decrypt_throwsWhenNonceLengthIsInvalid(): Unit {
    ...
    assertEquals(
      expected = "ChaCha20-Poly1305 nonce must be exactly 12 bytes.",
      actual = error.message,
      message = "AndroidCryptoProvider should reject malformed ChaCha20-Poly1305 nonces",
    )
  }
  ...
  public fun unsupportedPrimitives_throwHelpfulMessage(): Unit {
    ...
    // Assert
    val expectedMessage = "AndroidCryptoProvider primitive is not implemented yet."
  }
