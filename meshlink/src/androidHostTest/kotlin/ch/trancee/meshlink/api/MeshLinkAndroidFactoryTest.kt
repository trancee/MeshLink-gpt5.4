...
public class MeshLinkAndroidFactoryTest {
  ...
  public fun create_withConfigUsesTheConfiguredDiagnosticRedaction(): Unit {
    ...
    // Act
    api.send(peerId = PeerIdHex(value = "0011223344556677"), payload = byteArrayOf(0x01))
    val actual =
      api.diagnosticEvents.replayCache.single().payload as DiagnosticPayload.PeerLifecycle
