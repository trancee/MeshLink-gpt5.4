...
public class TransferScheduler {
    ...
    public companion object {
        private val scheduledTransferOrdering: Comparator<ScheduledTransfer> = compareBy<ScheduledTransfer> { scheduledTransfer ->
