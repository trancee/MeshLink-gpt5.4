...
public data class BleTransportConfig(
    ...
    init {
        require(scanIntervalMillis > 0) { "BleTransportConfig scanIntervalMillis must be greater than 0." }
        ...
        require(connectionTimeoutMillis > 0) { "BleTransportConfig connectionTimeoutMillis must be greater than 0." }
