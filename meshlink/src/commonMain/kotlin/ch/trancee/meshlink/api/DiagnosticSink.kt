...
private class SharedFlowDiagnosticSink(
    ...
    private val mutableDiagnosticEvents = MutableSharedFlow<DiagnosticEvent>(
        replay = bufferSize,
    ...
    override val diagnosticEvents: SharedFlow<DiagnosticEvent> = mutableDiagnosticEvents.asSharedFlow()
    ...
    override fun emit(
        ...
        // Arrange
        val actualPayload: DiagnosticPayload = payload()
            .let { resolvedPayload ->
                if (redactPeerIds) {
