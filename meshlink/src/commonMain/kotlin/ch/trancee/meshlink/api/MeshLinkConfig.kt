      ...
      internal fun build(regulatoryRegion: RegulatoryRegion): ScanningConfig {
        return ScanningConfig(
          scanDutyCyclePercent =
            regulatoryRegion.clampScanDutyCyclePercent(percent = scanDutyCyclePercent)
        )
      }
    }
  }
    ...
    public class Builder {
      ...
      internal fun build(): ConnectionsConfig {
        return ConnectionsConfig(
          maxPeerCount = maxPeerCount.coerceIn(minimumValue = 1, maximumValue = 16)
        )
      }
    }
  }
    ...
    public class Builder {
      ...
      internal fun build(): MessagingConfig {
        return MessagingConfig(
          maxPayloadBytes = maxPayloadBytes.coerceIn(minimumValue = 1, maximumValue = 100_000)
        )
      }
    }
  }
    ...
    public class Builder {
      ...
      internal fun build(): TransfersConfig {
        return TransfersConfig(
          chunkSizeBytes = chunkSizeBytes.coerceIn(minimumValue = 256, maximumValue = 4_096)
        )
      }
    }
  }
    ...
    public class Builder {
      ...
      internal fun build(): RoutingConfig {
        return RoutingConfig(
          maxRouteCount = maxRouteCount.coerceIn(minimumValue = 1, maximumValue = 512)
        )
      }
    }
  }
