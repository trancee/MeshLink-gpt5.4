...
public class FixedBatteryMonitor(
    initialBatteryPercent: Int,
) : BatteryMonitor {
    private var currentBatteryPercent: Int = validateBatteryPercent(batteryPercent = initialBatteryPercent)
